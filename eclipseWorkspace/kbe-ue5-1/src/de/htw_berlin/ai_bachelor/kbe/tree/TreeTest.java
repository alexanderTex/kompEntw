...
public class TreeTest {
	...
	public static void main(String... a) {
		...
		ComparePredicate<Integer> cp = new ComparePredicate(0,50);
		
		System.out.println(cp.isOk(t4));
		
		
		System.out.println(filterElements(cp, t4));
	}
	
	public static <V extends Comparable<V>> Collection<V> filterElements(ComparePredicate<V> cp, Tree<V> t) {
